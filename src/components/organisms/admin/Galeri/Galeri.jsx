...
import { useGaleriHandler } from "./HandlerGaleri";
...
const GaleriPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="mb-6 lg:mb-0">
                ...
                <p className="text-lg text-slate-600 max-w-2xl">
                  Kelola dan publikasikan galeri dengan sistem manajemen yang
                  modern dan intuitif
                </p>
              </div>
              <button
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 rounded-t-2xl">
              <h3 className="text-xl font-bold text-white">Tambah Galeri Baru</h3>
              <p className="text-blue-100 text-sm mt-1">
                Lengkapi informasi galeri yang akan dipublikasikan
              </p>
            </div>
            ...
            <div className="p-6">
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    placeholder="Tulis deskripsi atau keterangan..."
                    value={form.caption}
                    onChange={(e) =>
                ...
                <div className="flex gap-3 pt-6 border-t border-slate-200">
                  <button
                    ...
                    disabled={saving || !form.judul || !form.caption}
                  ...
                  <button
                    ...
                    disabled={saving}
                    className="flex-1 px-6 py-3 bg-slate-100 text-slate-700 font-semibold rounded-xl hover:bg-slate-200 focus:ring-3 focus:ring-slate-300 transition-all duration-200 disabled:opacity-50"
                  >
                    Batal
                  </button>
                </div>
      ...
      {/* Modal Edit Galeri */}
      {isEditModalOpen && selectedGaleri && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            <div className="bg-gradient-to-r from-green-600 to-green-700 p-6 rounded-t-2xl">
              <h3 className="text-xl font-bold text-white">Edit Galeri</h3>
              <p className="text-green-100 text-sm mt-1">
                Perbarui informasi galeri #{selectedGaleri.id}
              </p>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-3 focus:ring-green-200 focus:border-green-500 transition-all duration-200 placeholder-slate-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-3 focus:ring-green-200 focus:border-green-500 transition-all duration-200 resize-none placeholder-slate-400"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-3 focus:ring-green-200 focus:border-green-500 transition-all duration-200 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100"
                  />
                  <p className="text-xs text-slate-500 mt-2">
                  ...
                  {selectedGaleri.gambar && (
                    <div className="mt-4 p-3 bg-slate-50 rounded-xl">
                      ...
                      <img
                        src={`${BASE_URL}/storage/${selectedGaleri.gambar}`}
                ...
                <div className="flex gap-3 pt-6 border-t border-slate-200">
                  <button
                    onClick={handleEdit}
                    disabled={saving || !form.judul || !form.caption}
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-xl hover:from-green-700 hover:to-green-800 focus:ring-3 focus:ring-green-300 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  >
                    {saving ? (
                      <div className="flex items-center justify-center">
                        <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
